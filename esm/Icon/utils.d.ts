...
export declare const getUrl: (i: any) => string | null;
export declare const getNamedUrl: (iconName: string) => string;
 ...
 */
export declare const isRTL: (hostEl?: Pick<HTMLElement, "dir"> | undefined) => boolean;
