...
export default (function (_ref) {
  ...
  switch (data.dataType) {
    case 'text':
      return /*#__PURE__*/_jsx(TextRender, {});
    case 'boolean':
    ...
    case 'upload':
      return /*#__PURE__*/_jsx(Upload, {
        antProps: data.childrenProps,
        onRequest: (_data$onUpload = data.onUpload) !== null && _data$onUpload !== void 0 ? _data$onUpload : onUploadNUll
      });
    case 'tree':
...
// 上传组件方法不存在时
function onUploadNUll(_x) {
  return _onUploadNUll.apply(this, arguments);
}
function _onUploadNUll() {
  _onUploadNUll = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(file) {
